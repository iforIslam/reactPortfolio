    ...
    <div name='contact' className='bg-gradient-to-b from-black to-gray-800 w-full pt-20 text-white'>
      <div className='max-w-screen-lg mx-auto p-4 flex flex-col justify-center h-full'>
        ...
        <div className='flex justify-center items-center'>
          <form action="https://getform.io/f/azylvzwb" method='POST' className='flex flex-col w-full md:w-1/2'>
            ...
            <button className='text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-5 py-2 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300'>Let's Talk</button>
          </form>
        </div>
      </div>
    </div>
